...
public class InviteActivity extends Activity {
    ...
    private InviteAdapter.OnInviteListener mOnInviteListener = new InviteAdapter.OnInviteListener() {
        @Override
        public void onAccept(final InvationInfo invatationInfo) {
        ...
        @Override
        public void onReject(final InvationInfo invatationInfo) {
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                @Override
                public void run() {
                    try {
        ...
        @Override
        public void onApplicationReject(final InvationInfo invatationInfo) {
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                @Override
                public void run() {
                    try {
        ...
        @Override
        public void onApplicationAccept(final InvationInfo invatationInfo) {
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                @Override
                public void run() {
                    try {
        ...
        @Override
        public void onInviteAccept(final InvationInfo invatationInfo) {
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                @Override
                public void run() {
                    try {
        ...
        @Override
        public void onInviteReject(final InvationInfo invatationInfo) {
